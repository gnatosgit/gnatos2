			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Sitemap delle località - Gnatos Studio Dentistico</title>
					</xsl:when>
					<xsl:otherwise>
						<title>Sitemap XML - Gnatos Studio Dentistico</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://www.gnatos.it/sitemap_index.xml">&#8592; Indice Sitemap</a>							</p>
